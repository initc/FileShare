...
public class FileUtils {
	...
	public static boolean  uploadFile(){  
        ...
        String name;
		try {
			name = URLEncoder.encode("123456","utf-8");
			 Map<String, String> params = new HashMap<String, String>();         
		        params.put("text", name);     
		        File file = new File("C:\\Users\\lenovo\\Pictures\\photo\\a3.png");
		         upfiles.put("xiaojie.png",file);
		       post("http://127.0.0.1/StrutsLogin/updown.do", params, upfiles); 
		       re=true;
		       return re;
